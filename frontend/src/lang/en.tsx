...
const en: Lang = {
  ...
  messagePagChoicePasswordTitle: "Choose a password",
  messagePagChoicePasswordOld: "Current password",
  messagePagChoicePasswordNew: "New password",
  messagePagChoicePasswordButton: "Validate",
};
