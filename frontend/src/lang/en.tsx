...
const en: Lang = {
  ...
  titleAboutMe: "<h3 style='font-weight: bold; font-size: 1.875rem; margin-bottom: 1rem;'>Hello 👋, my name is Alexandre</h3>",
  descriptionAboutMe: "I am a junior French developer, passionate about computer science and web development since my childhood. I have completed my training in web development, and I am currently looking for a professional opportunity. Discover my portfolio to learn more about my journey and projects!",
