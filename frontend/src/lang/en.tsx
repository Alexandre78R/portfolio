...
const en: Lang = {
  ...
  descriptionAboutMe2: "I have completed my training in web development, and I am currently looking for a professional opportunity.",
  descriptionAboutMe3: "Discover my portfolio to learn more about my journey and projects!",
