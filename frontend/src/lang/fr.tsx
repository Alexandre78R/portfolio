...
const fr: Lang = {
    ...
    descriptionAboutMe3 : "Découvrez mon portfolio pour en apprendre davantage sur mon parcours et mes projets !",
    ...
    messageErrorServerOff: "Impossible de contacter le serveur. Veuillez réessayer plus tard.",
