    ...
    <footer className="bg-footer text-text py-4">
      <div className="container mx-auto flex flex-wrap justify-center">
        <div className="flex flex-col items-center mb-4 md:mb-0  lg:mx-15 flex-1">
            <h5 className="text-lg font-bold mb-2">{translations.footerTitle}</h5>
            <ul>
          ...
          <div className="flex flex-col items-center mx-4 mb-4 md:mb-0 lg:mx-25 flex-1">
            <h5 className="text-lg font-bold mb-2">{translations.footerNetworks}</h5>
          ...
          <div className="flex flex-col items-center mx-4 mb-4 md:mb-0 lg:mx-25 flex-1">
          <h5 className="text-lg font-bold mb-2" >{translations.footerContact}</h5>
