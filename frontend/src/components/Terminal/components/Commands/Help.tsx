    ...
    <Message data-testid="help">
      ...
      <div className="text-sm mt-4 hidden md:block lg:block">
        <ul>
          <li>
            <p>
              {translations.terminalHelpTabAction} =&gt;{" "}
              {translations.terminalHelpTabDesc}
            </p>
          </li>
          <li>
            <p>
              {translations.terminalHelpArrowUpAction} =&gt;{" "}
              {translations.terminalHelpArrowUpTabDesc}
            </p>
          </li>
          <li>
            <p>
              {translations.terminalHelpArrowDownAction} =&gt;{" "}
              {translations.terminalHelpArrowDownTabDesc}
            </p>
          </li>
          <li>
            <p>
              {translations.terminalHelpCtrlAction} =&gt;{" "}
              {translations.terminalHelpCtrlTabDesc}
            </p>
          </li>
        </ul>
      </div>
