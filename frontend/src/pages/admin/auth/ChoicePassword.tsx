...
const ChoicePasswordPage = (): React.ReactElement => {
  ...
  return (
    <AuthFormLayout title={translations?.messagePagChoicePasswordTitle}>
      <form className="space-y-4" onSubmit={handleSubmit}>
        <InputField
          id="choice-password"
          name="password"
          label={translations?.messagePagChoicePasswordOld}
          type="password"
          value={form.password}
        ...
        <InputField
          ...
          name="newPassword"
          label={translations?.messagePagChoicePasswordNew}
          type="password"
        ...
        <div className="flex justify-center">
          <ButtonCustom
            text={translations?.messagePagChoicePasswordButton}
