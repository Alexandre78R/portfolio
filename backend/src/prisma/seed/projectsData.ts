export const projectsData = [
  {
    ...
    title: "Semantik",
    descriptionEN:
      "Semantik is an innovative SEO tool that allows you to identify the most frequently asked questions by internet users on Google. By simply entering your topic, you get a comprehensive list of these questions in one click. Use them to optimize the semantics of your content and meet SEO needs.",
    descriptionFR:
  ...
  },
  {
    ...
    title: "Tchat",
    descriptionEN:
      "Tchat is a real-time chat application where users can send messages to each other instantly. The frontend is developed in React, while the backend uses Express and WebSocket to handle real-time communication.",
    descriptionFR:
